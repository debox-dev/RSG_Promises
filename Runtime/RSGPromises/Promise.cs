...
namespace RSG
{
    ...
    /// Util class for RSG
    /// </summary>
    public static class RSGUtil
    {
        /// <summary>
        /// Verbally announce catching an exception
        /// </summary>
        public static bool EnableLogCaughtExceptions;

        /// <summary>
        /// Log format for debugged exceptions
        /// </summary>
        public static string ExceptionLogFormat = "RSG caught {0}: {1}\n{2}";

        public static void LogCaughtException(Exception ex)
        {
            if (!EnableLogCaughtExceptions)
            {
                return;
            }
